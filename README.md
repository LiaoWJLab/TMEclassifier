...
-   4.In addition, TMEclassifier provides functions for multi-scale
    visualization of TMEcluster and some functions was depend on `IOBR`,
...
#> [16:12:24] WARNING: amalgamation/../src/learner.cc:1040: 
...
#> 
#> [16:12:24] WARNING: amalgamation/../src/learner.cc:749: Found JSON model saved before XGBoost 1.6, please save the model using current version again. The support for old JSON model will be discontinued in XGBoost 2.3.
#> 
#> >>>--- DONE!
head(res)
...
1.Zeng D, Qiu W, Mao Q, …, Liao W; **TMEclassifier**: Classification of
gastric cancer based on tumor microenvironment reveals distinct
biological characteristics and implications for combination
immunotherapies. (2022) *Under Review*.
