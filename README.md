...
depens<-c("crayon", "ggplot2", "scales", "tibble", "caret", "e1071", "randomForest", "survminer", "ggpubr")
...
#> [12:35:09] WARNING: amalgamation/../src/learner.cc:1040: 
...
#> 
#> [12:35:09] WARNING: amalgamation/../src/learner.cc:749: Found JSON model saved before XGBoost 1.6, please save the model using current version again. The support for old JSON model will be discontinued in XGBoost 2.3.
#> 
#> >>>--- DONE!
head(res)
...
1.Zeng D, Qiu W, Mao Q, …, Liao W; **TMEclassifier**: Tumor
microenvironment classification of gastric cancer reveals distinct
biological characteristics and theraputic implications. (2022) *Under
Review*.
