...
-   1.TMEclassifier is proposed for the classification of tumor
    microenvironment(TME) of gastric cancer and even other cancers.
-   2.TMEclassifier extracts a set of 134 gene expression representing
    TME characteristics from RNA-seq or microarray and classifies them
    into three TME clusters.
-   3.TMEclassifier integrates 6 machine learning algorithms for
    classification, comprising ‘svm’, ‘rf’, ‘nnet’, ‘knn’, ‘dt’,
    ‘xgboost’.
-   4.TMEclassifier provides batch visualization of TMEcluster
    characteristics depending on the package named IOBR, which was
    proposed by our team previously. The more information about IOBR can
    be found in <https://pubmed.ncbi.nlm.nih.gov/34276676/>.
...
The dependencies includes `crayon`, `ggplot2`, `scales`, `tible`,
...
if (!requireNamespace("TMEclassifier", quietly = TRUE))
  devtools::install_github("DongqiangZeng0808/TMEclassifier")
```
...
#> [00:53:43] WARNING: amalgamation/../src/learner.cc:1040: 
...
#> 
#> [00:53:43] WARNING: amalgamation/../src/learner.cc:749: Found JSON model saved before XGBoost 1.6, please save the model using current version again. The support for old JSON model will be discontinued in XGBoost 2.3.
#> 
#> >>>--- DONE!
head(res)
...
page](https://github.com/DongqiangZeng0808/TMEclassifier/issues)
